...
[**Fibonacci Sequence**](https://github.com/vdrey/Project-Programs/blob/master/Python/fibSequence.py)

**Prime Factorization** - Have the user enter a number and find all Prime Factors (if there are any) and display them.

**Next Prime Number** - Have the program find prime numbers until the user chooses to stop asking for the next one.

[**Find Cost of Tile to Cover W x H Floor**](https://github.com/vdrey/Project-Programs/blob/master/Python/Tile%20cost.py)
...
[**Tax Calculator**](https://github.com/vdrey/Project-Programs/blob/master/Python/Tax%20Calculator.py)
...
[**Collatz Conjecture**](https://github.com/vdrey/Project-Programs/blob/master/Python/Collatz.py)
...
[**Check if Palindrome**](https://github.com/vdrey/Project-Programs/blob/master/Python/Check%20if%20Palindrome.py)
...
[**Caesar cipher**](https://github.com/vdrey/Project-Programs/blob/master/Python/caesarCipher.py)
